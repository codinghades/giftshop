...
<body>
            ...
            <div class="nav-section">
                <div class="left">
                    ...
                    <div class="nav-links">
                        ...
                        <a href="#limitedSection" class="css-links" >Limited-Time-Sales</a>
                        <a href="#arrivalSection" class="css-links" >New Arrivals</a>
                ...
                <div class="right">
                    ...
                    <form action="shop.php" method="get">
                        <div class="search-bar">
                            <input placeholder="Jujutsu Kaisen🔥" id="search" class="search" type="text" name="search-product">
    ...
    <div class="main">
        ...
        <div class="limited-section" id="limitedSection">
            <!--Limited Time Sales-->
            <div class="limited">
        ...
        <div class="arrivalSection" id="arrivalSection">
    ...
    <div class="footer">
        ...
        <div class="footer-box">
            ...
            <a href="#arrivalSection">New Arrivals</a><br><br>
            <a href="#limitedSection">Limited-Time-Sales</a>
            </div>
        <div class="footer-box">
            <h4>Quick Link</h4>
    ...
    if (window.location.pathname === 'homepage.php') {
        reloadSlider();
    }
});
